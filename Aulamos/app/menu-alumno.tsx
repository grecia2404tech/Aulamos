...
export default function MenuAlumnoScreen() {
  ...
  const [usuario, setUsuario] =
    useState<UsuarioAlumno | null>(null);
  ...
  const mostrarPerfil = () => {
    ...
    anunciar(
      `Perfil del alumno. Nombre ${nombreCompleto}. Correo ${usuario.correo}.`,
    );
  ...
  const mostrarNotificaciones = () => {
    ...
    Alert.alert(
      'Notificaciones',
      'Aquí aparecerán los avisos, actividades nuevas y recordatorios del alumno.',
    );
  };
    ...
    >
      ...
      >
        <View
          ...
          accessible
          accessibilityLabel={`Alumno ${nombreCompleto}. ${
            usuario?.correo ??
        ...
        <View
          ...
          accessible
          accessibilityLabel="El chatbot puede ayudarte con dudas sobre tus actividades y recursos educativos."
        >
          <Ionicons
          ...
          >
            El chatbot puede ayudarte con dudas
            sobre tus actividades y recursos
            educativos dentro de AULAMOS.
          </Text>
        </View>
      </ScrollView>
